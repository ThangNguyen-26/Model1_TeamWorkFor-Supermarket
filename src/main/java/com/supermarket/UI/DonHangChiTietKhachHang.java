 ...
 * @author TranVanNhan
 */
public class DonHangChiTietKhachHang extends javax.swing.JFrame {

    /**
     * Creates new form HoaDonChiTietFinal
     */
    public DonHangChiTietKhachHang() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonHangChiTietKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DonHangChiTietKhachHang().setVisible(true);
            }
        });
    }
